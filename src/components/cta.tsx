...
export default function CTA() {
  return (
    <section className="relative bg-black-main text-white overflow-hidden">
      <div className="max-w-[1200px] mx-auto pl-6 pr-0 md:pl-6 md:pr-2 grid md:grid-cols-2 gap-8 items-center min-h-[220px] md:min-h-[280px]">
        {/* Left: Text */}
        <div className="py-6 md:py-8 md:-ml-4">
          <h2
            className="text-3xl md:text-5xl uppercase tracking-tight leading-[0.95] mb-2"
        ...
        {/* Right: Car Image + Buttons (separate) */}
        <div className="relative h-full flex flex-row items-center justify-between gap-4">
          ...
          {/* Buttons (separate, not overlaying) */}
          <div className="flex flex-col gap-3 mb-2 shrink-0 md:translate-x-16">
            <a
              href="/contact"
